...
@freezed
class CourseScoresModel with _$CourseScoresModel {
  @JsonSerializable(explicitToJson: true, fieldRename: FieldRename.snake)
  const factory CourseScoresModel({
    String? courseId,
    String? courseName,
    double? exams,
    double? homeworks,
  ...
  factory CourseScoresModel.fromJson(Map<String, dynamic> json) =>
      _$CourseScoresModelFromJson(json);
}
