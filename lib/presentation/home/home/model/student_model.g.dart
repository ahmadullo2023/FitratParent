...
_$LearningResponseImpl _$$LearningResponseImplFromJson(
    ...
    _$LearningResponseImpl(
      ...
      fullName: json['full_name'] as String?,
      overallLearning: json['overall_learning'] as num?,
      courseScores: (json['course_scores'] as List<dynamic>?)
          ?.map((e) => CourseScoresModel.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
...
Map<String, dynamic> _$$LearningResponseImplToJson(
    ...
    <String, dynamic>{
      ...
      'course_scores': instance.courseScores?.map((e) => e.toJson()).toList(),
    };

_$CourseScoresModelImpl _$$CourseScoresModelImplFromJson(
        Map<String, dynamic> json) =>
    _$CourseScoresModelImpl(
      courseId: json['course_id'] as String?,
      courseName: json['course_name'] as String?,
      exams: (json['exams'] as num?)?.toDouble(),
      homeworks: (json['homeworks'] as num?)?.toDouble(),
      speaking: (json['speaking'] as num?)?.toDouble(),
      unit: (json['unit'] as num?)?.toInt(),
      mock: (json['mock'] as num?)?.toInt(),
      overall: (json['overall'] as num?)?.toDouble(),
    );

Map<String, dynamic> _$$CourseScoresModelImplToJson(
        _$CourseScoresModelImpl instance) =>
    <String, dynamic>{
      'course_id': instance.courseId,
