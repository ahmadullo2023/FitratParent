...
mixin _$FileModel {
  ...
  String? get choiceUrl => throw _privateConstructorUsedError;
...
abstract class $FileModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? id, String? file, String? choiceUrl, String? url});
}
    ...
    return _then(_value.copyWith(
      ...
      file: freezed == file
          ...
          : file // ignore: cast_nullable_to_non_nullable
              as String?,
      choiceUrl: freezed == choiceUrl
          ? _value.choiceUrl
          : choiceUrl // ignore: cast_nullable_to_non_nullable
              as String?,
      url: freezed == url
          ? _value.url
...
class _$FileModelImpl implements _FileModel {
  const _$FileModelImpl({this.id, this.file, this.choiceUrl, this.url});
...
// video: mp4, mov, audio: mp3, rasm:  png, jpeg(jpg),
  @override
  final String? choiceUrl;
  @override
  final String? url;

  @override
  String toString() {
    return 'FileModel(id: $id, file: $file, choiceUrl: $choiceUrl, url: $url)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.choiceUrl, choiceUrl) ||
                other.choiceUrl == choiceUrl) &&
            (identical(other.url, url) || other.url == url));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, file, choiceUrl, url);
